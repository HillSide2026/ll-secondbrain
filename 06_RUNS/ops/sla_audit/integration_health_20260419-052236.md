---
run_id: 20260419-052236
timestamp: 2026-04-19T05:22:36.625436Z
...
|---|---|---|
| .mcp.json → gmail | FAIL | Path exists but is not executable: /Users/matthewlevine/Repos/ll-secondbrain_fresh/scripts/gmail_mcp_server.py |
| .mcp.json → sharepoint | FAIL | Path exists but is not executable: /Users/matthewlevine/Repos/ll-secondbrain_fresh/scripts/sharepoint_mcp_server.py |
| .claude/settings.json → PreToolUse hook | PASS | — |
...
- **.mcp.json → gmail**: Path exists but is not executable: /Users/matthewlevine/Repos/ll-secondbrain_fresh/scripts/gmail_mcp_server.py
- **.mcp.json → sharepoint**: Path exists but is not executable: /Users/matthewlevine/Repos/ll-secondbrain_fresh/scripts/sharepoint_mcp_server.py
