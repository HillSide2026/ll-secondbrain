# Soft Junk Review 20260314_174402Z

- Query: `in:inbox (category:promotions OR category:social OR category:forums)`
- Threads scanned: `50`
- Matter matched: `7`
- Matter ambiguous: `0`
- Soft-junk archive candidates: `43`
- Ready matter-label adds: `7`
- Ready state-label adds: `7`

## Matter-associated threads

- `19ce611214725f37` | `25-1318-00001` | matter_actions=ready_add | state_actions=ready_add | subject=March 2026: Western Canadian Guide to a Successful Business Sale
- `19cbfb7b96379cda` | `25-194-00059` | matter_actions=ready_add | state_actions=ready_add | subject=Let’s continue the conversation in person
- `19c94d9312f82cca` | `25-927-00003` | matter_actions=ready_add | state_actions=ready_add | subject=Stream Confirmation - Send Mail as f.t.m@stream.money
- `19c94d57ea7f7b6c` | `25-927-00003` | matter_actions=ready_add | state_actions=ready_add | subject=Stream Confirmation - Send Mail as onboarding@stream.money
- `19c941bb26ebaf1e` | `25-927-00003` | matter_actions=ready_add | state_actions=ready_add | subject=Action Required: GCEX Onboarding Assessment Completion
- `19c94198f29279a4` | `25-927-00003` | matter_actions=ready_add | state_actions=ready_add | subject=GCEX Online Application for Digital Assets (UAE Entity)
- `19c909858970fc63` | `25-927-00003` | matter_actions=ready_add | state_actions=ready_add | subject=Stream Confirmation - Send Mail as onboarding@stream.money
