...
This tracker covers Levine Law tasks owned by ML1. Use `LL Task Type` to
...
## Client Demand / Profitability Intake

_This section is for ML1 reality-capture. It is intentionally commercial, not just task-based. Update these rows when the old matter list does not reflect actual client demand, delivery pressure, revenue quality, or firm profitability._

**Profitability question:** what work should Levine Law keep, price higher, delegate, systematize, collect, pause, or stop doing so that client demand turns into durable profit rather than ML1 overload?

**Capacity rule:** more marketing and more selectivity require non-ML1 capacity. Each matter should identify what can be handled by staff, clerk, freelancer, contractor, or system support before ML1 review.

| Matter ID | Client / Matter | Delivery | Reality of client demand | Revenue / collectability | ML1 load | Delegation / system fit | Profitability posture | Next commercial action |
|---|---|---|---|---|---|---|---|---|
...
| 26-1639-00002 | Andersen | Essential | Potential client work / trade remedies pipeline noted in file |  |  |  |  |  |
| 26-1639-00003 | Andersen | Essential | Potential client work / agri-food market-access pipeline noted in file |  |  |  |  |  |
...
| 24-256-00005 | Aspire Infusions Inc — Legal Strategy | Strategic | Outstanding fees / collections surfaced in active task tracker |  |  |  |  | Collect outstanding fees and decide whether further work is blocked pending payment |
| 24-336-00004 | Mascore Helical Piles | Strategic | Cohabitation agreement ready for client circulation |  |  |  |  | Send to client |
| 25-1231-00001 | Charmaine Spiteri | Strategic | Waiting on CRA representative authorization |  |  |  |  | Follow up with Charmaine |
| 26-1631-00001 | 1713425 Ontario Inc. (Tejvir Boparai) | Strategic | Subway transaction / transfer work |  |  |  |  |  |
| 26-1637-00001 | MRKT (Nilabh Anand) | Strategic | Founders / shareholder agreement work; comments pending |  |  |  |  | Send comments to Laura |
| 22-194-00006 | Rousseau Mazzuca LLP | Standard |  |  |  |  |  | Follow up |
| 23-194-00013 | Rousseau Mazzuca LLP | Standard |  |  |  |  |  | No action identified |
| 23-235-00001 | Baobab Energy Africa Ltd | Standard |  |  |  |  |  | No action identified |
| 24-646-00001 | ByNature Design | Standard | Client response needed |  |  |  |  | Confirm whether this is active paying work or stale follow-up |
| 25-1185-00001 | Alexander Klys | Standard | Second business acquisition appears instructed but not scoped |  |  |  |  | Scope Deal 2 intake and price before work expands |
| 25-1318-00001 | Zelko Culibrk | Standard | Closing/admin work |  |  |  |  | Close file |
| 25-1363-00001 | Raevan Joy Sambrano | Standard |  |  |  |  |  | No action identified |
| 25-1525-00001 | Kleenup Cleaning Services Inc. | Standard |  |  |  |  |  | No action identified |
| 25-1538-00002 | Georgiana Nicoară | Standard |  |  |  |  |  | No action identified |
...
| 25-1614-00001 | HillSide | Standard | Strategic internal / affiliated work, not ordinary client demand |  |  |  |  | Separate from client-profitability analysis unless billable/recoverable |
...
| 26-1593-00002 | 1001162998 Ontario Corp. o/a KaleMart | Standard | Client appears to want to re-engage |  |  |  |  | Confirm scope, retainer, and whether old file should close or reopen |
| 26-259-00003 | LL Onboarding | Standard | Internal/onboarding work, not ordinary client demand |  |  |  |  | Exclude from client-profitability analysis unless tied to paid intake |

### Profitability Lens

For each real matter, classify the work into one of five postures:

| Posture | Meaning | Firm response |
|---|---|---|
| Grow | Profitable, repeatable, strategically aligned demand | Protect capacity, improve throughput, ask for referrals, package the offer |
| Price up | Valuable but underpriced or too bespoke | Reprice, narrow scope, require deposits, define change orders |
| Delegate | Work is valuable but does not require ML1 for every step | Push to clerk/freelancer/templates with ML1 review gates |
| Collect / pause | Work may be valid but cash discipline is weak | Collect AR, refresh retainer, pause new work until payment is clean |
| Exit / close | Low-value, stale, noisy, or non-strategic work | Close file, decline expansion, or convert to paid diagnostic only |

### Non-ML1 Capacity Lens

| Capacity Need | Use when | Candidate owner |
|---|---|---|
| Intake / qualification | Client demand is unclear, budget is unknown, or scope is not priced | Assistant / intake support / system checklist |
| Matter admin | Work is blocked by signatures, documents, reminders, retainers, AR, or file closing | Admin support |
| First-pass legal production | Work is repeatable, precedent-driven, or checklist-driven before ML1 review | Clerk / lawyer contractor / freelancer |
| Marketing execution | Work involves publishing, CRM hygiene, follow-up, or funnel maintenance | Marketing contractor / VA / system |
| Finance / collections | Work should not expand until payment, retainer, or AR status is clean | Bookkeeper / admin / finance support |

## Active Tasks

| Matter ID | Client | LL Task Type | Delivery Status | Service | Task | Status | Due |
|---|---|---|---|---|---|---|---|
| 00_SYSTEM/integrations/plane/IMPLEMENTATION_PLAN.md | LL Systems | LL Firm Management Task | — | Systems / Infrastructure | Self-host Plane via Docker: clone makeplane/plane repo, configure env vars, run `docker compose up`, create first admin user. Docker available. Target: localhost. See plan. | Open | |
| 00_SYSTEM/integrations/plane/IMPLEMENTATION_PLAN.md | LL Systems | LL Firm Management Task | — | Systems / Infrastructure | Connect secondbrain to self-hosted Plane: set PLANE_API_KEY, PLANE_WORKSPACE_SLUG, PLANE_API_BASE_URL; run `npm run setup:plane` (36 projects); run `npm run sync:plane`. Depends on Plane self-host task above. See plan. | Open | |
...
_Completed tasks are retained here. The system will not recreate a task that appears in this section. Follow-up tasks are distinct tasks with distinct descriptions._
...
| 26-927-00004 | Stream Ventures Limited | LL Legal Task | Counsel | Finalize Enterprise Platform Agreement for Equals customers | 2026-05-17 |
| 26-927-00004 | Stream Ventures Limited | LL Legal Task | Counsel | RPAA registration | 2026-05-17 |
| 26-927-00004 | Stream Ventures Limited | LL Legal Task | Counsel | Complete RPAA: Incident Risk Policy | 2026-05-17 |
| 26-927-00004 | Stream Ventures Limited | LL Legal Task | Counsel | Complete RPAA Application | 2026-05-17 |
| 25-845-00001 | STAR 333 SPORTS INC. | LL Legal Task | Corporate | Proceed with extra-provincial BC registration — address confirmed (Sharanjit Singh, 10993 Lyon Rd, Delta BC) | 2026-05-17 |
| 25-845-00002 | STAR 333 SPORTS INC. | LL Legal Task | Litigation | Review Sonia's tracked changes to Notice of Arbitration and send | 2026-05-17 |
| 26-1631-00001 | 1713425 Ontario Inc. (Tejvir Boparai) | LL Legal Task | Corporate | Review and action Subway Transfer Initiation Documents — ref #37499, forwarded by client March 24 | 2026-05-17 |
| 24-336-00004 | Mascore Helical Piles | LL Admin Task | Corporate | Find replacement family lawyer and send cohabitation agreement for ILA review | 2026-05-17 |
| 25-927-00003 | Stream Ventures Limited | LL Legal Task | CAMLO | Follow up: AML-ATF Risk Assessment client approval | 2026-03-22 |
| 25-927-00003 | Stream Ventures Limited | LL Legal Task | CAMLO | Follow up: Wolfsberg FCCQ client feedback | 2026-03-22 |
| 26-927-00004 | Stream Ventures Limited | LL Legal Task | Counsel | Send Diameter Agreement to client | 2026-03-22 |
...
| Waiting | Blocked — waiting on client, counterparty, third party, or LL admin |
