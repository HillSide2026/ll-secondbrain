---
id: mkt_distribution_orchestration_agent
title: Distribution Orchestration Agent Charter
owner: ML1
status: active
...
# Distribution Orchestration Agent Charter
...
## Outputs
- Distribution Package Bundle
- Channel-ready deployment manifests
...
## Definition of Done
- Channel packages are complete and traceable to approved source assets.
- Required release gates and approval dependencies are explicitly listed.
