...
| --- | --- | --- | --- | --- | --- | --- | --- |
| sharepoint | SharePoint | initiated | ML1 | 00_SYSTEM/integrations/sharepoint/sharepoint_sources.yaml | 00_SYSTEM/integrations/sharepoint/sharepoint_sources.yaml<br>00_SYSTEM/scripts/sharepoint_integration.py<br>00_SYSTEM/scripts/sharepoint_discovery.py<br>00_SYSTEM/scripts/setup_sb_execution.py | 00_SYSTEM/scripts/sharepoint_integration.py<br>00_SYSTEM/scripts/sharepoint_discovery.py<br>00_SYSTEM/scripts/setup_sb_execution.py | Config present; Word drafting handled via microsoft_word contract. Uses 00_SYSTEM/matters/matter_identity_map.yaml for matter_id aliasing/routing. |
| gmail | Gmail | initiated | ML1 | 00_SYSTEM/integrations/gmail/gmail_sources.yaml | 00_SYSTEM/scripts/gmail_integration.py<br>00_SYSTEM/scripts/fetch_gmail.py<br>00_SYSTEM/scripts/gmail_labeler.py<br>06_RUNS/ops/gmail_fetch_latest.json | 00_SYSTEM/scripts/gmail_integration.py<br>00_SYSTEM/scripts/fetch_gmail.py<br>00_SYSTEM/scripts/gmail_labeler.py<br>00_SYSTEM/scripts/run_pilot.py | participant_mapping.yaml canonical path: 00_SYSTEM/participant_mapping.yaml. Uses 00_SYSTEM/matters/matter_identity_map.yaml for matter_id aliasing/routing. |
...
| lexaro | Lexaro | initiated | ML1 | 00_SYSTEM/integrations/lexaro/README.md | scripts/lexaro_smoke_test.py | scripts/lexaro_smoke_test.py | Mode 1 read-only smoke test implemented. Auth format confirmed (X-Api-Key + X-Api-Secret). Blocked: Lexaro returns HTTP 500 in external API middleware for all credential combinations — server-side bug. Next step: contact Lexaro support. Read-only only; no writes permitted. |
