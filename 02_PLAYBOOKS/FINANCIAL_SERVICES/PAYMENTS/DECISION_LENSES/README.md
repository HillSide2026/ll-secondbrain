...
## Playbook Header
Playbook ID: 02_playbooks__financial_services__payments__decision_lenses__readme_md
Version: 1.0
Status: draft
...
| File | Purpose |
|------|---------|
| [LENS_INDEX.md](LENS_INDEX.md) | Index of registered decision lenses |
| [TEMPLATES/LENS_TEMPLATE.md](TEMPLATES/LENS_TEMPLATE.md) | Template for creating new decision lenses |
