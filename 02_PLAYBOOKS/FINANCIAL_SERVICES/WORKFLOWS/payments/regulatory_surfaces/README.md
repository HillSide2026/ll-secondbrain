...
## Playbook Header
Playbook ID: 02_playbooks__financial_services__payments__regulatory_surfaces__readme_md
Version: 1.0
Status: draft
...
| File | Purpose |
|------|---------|
| [SURFACE_INDEX.md](SURFACE_INDEX.md) | Index of registered regulatory surfaces |
| [templates/SURFACE_TEMPLATE.md](templates/SURFACE_TEMPLATE.md) | Template for documenting new regulatory surfaces |
