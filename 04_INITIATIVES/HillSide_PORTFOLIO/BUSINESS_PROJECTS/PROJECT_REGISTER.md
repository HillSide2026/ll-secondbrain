...
| HBP-011 | Payment Services Consulting Line | HBP-011_PAYMENTS_REGULATORY_COMPLIANCE_AGENCY | executing | Execute the HBP-014 payment-services service line under `17513721 Canada Inc` using an agency business model, two entry points (FinSure STR report and FINTRAC readiness lead magnet / paid consultation offer), and a six-tier non-legal services ladder | Weak differentiation, slow revenue ramp, execution sprawl, outsourced-provider dependency | approved | ML1 | 2026-03-20 |
