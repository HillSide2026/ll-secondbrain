...
| Andersen Service Line economics may be omitted, misclassified, or double-counted across Levine Law and `17513721 Canada Inc` | Financial / governance | M | H | Lock the cross-entity reconciliation rule so Andersen can be credited to Levine Law in planning without obscuring the underlying cash path |
