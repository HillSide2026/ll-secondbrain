---
id: 04_initiatives__hillside_portfolio__matthew_holdings_17513721_canada_inc__corporate_identity_card_md
title: Corporate Identity Card — Matthew Holdings (17513721 Canada Inc)
owner: ML1
status: draft
...
# Corporate Identity Card — Matthew Holdings
...
| Incorporation Date | TBD | Pending confirmation |
| Directors | TBD | Pending confirmation |
| Registered Office | TBD | Pending confirmation |
| BN / Tax IDs | TBD | Pending confirmation |
| Corporate Status | Active holding company (working status) | Pending legal confirmation |

## Corporate Function

Matthew Holdings functions as the ownership and governance vehicle for HillSide portfolio entities.
...
- This card is a portfolio governance summary, not a replacement for formal legal records.
- Formal legal records remain in firm systems of record.
