---
id: 04_initiatives__hillside_portfolio__matthew_holdings_17513721_canada_inc__1_potential_business_initiatives__initiative_portfolio_md
...
Use this table to track the Matthew Holdings initiative portfolio.

| Initiative ID | Initiative Name | Portfolio Fit | Stage | Transaction Status Tag | Strategic Rationale | Key Risks | ML1 Decision | Owner | Last Updated |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| PBI-001 | Sale of YellowBricks | 2A_YELLOWBRICKS | closing | post-closing | Liquidity event | Financial risk: valuation may be below target. Financial risk: cost of finding buyer may exceed baseline. Schedule risk: FINTRAC responses may delay closing. Schedule risk: overall transaction timeline may slip. Scope risk: transaction work may expand beyond the initial sale process. | pending | TBD | 2026-03-12 |
| PBI-002 | Sale of Ontario MSBShellCo | 2C_ONTARIO_MSB_CORP_1001494374_ONTARIO_CORP | initiating | - | Monetize regulated shell | Financial risk: cost of finding buyer may exceed baseline. Schedule risk: FINTRAC responses may delay closing. Schedule risk: closing is targeted for 2026 but timing is not fully controllable. Scope risk: transaction work may expand beyond the initial sale process. | pending | TBD | 2026-03-12 |
| PBI-003 | Andersen Tie-Up | Cross-Portfolio Strategic Partnership | initiating | - | Grow via external partnership/distribution leverage | Strategic risk: partnership objectives or incentives may become misaligned. Strategic risk: the tie-up may create dependency on external distribution or delivery channels. Scope risk: partnership design may introduce added complexity. Scope risk: integration overhead may expand execution demands. | pending | TBD | 2026-03-12 |
...
- `initiating`: initiative is being framed, screened, and initially monitored before execution commitment
- `planning`: initiative scope, roadmap, assumptions, risks, and decision criteria are being formalized
- `executing`: approved work is actively being carried out, with increased monitoring during execution
- `closing`: primary execution is complete and the initiative is in close-out, residual follow-through, or post-closing handling
