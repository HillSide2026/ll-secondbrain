---
id: 04_initiatives__hillside_portfolio__matthew_holdings_17513721_canada_inc__1_potential_business_initiatives__initiative_pipeline_md
title: Initiative Pipeline
owner: ML1
status: draft
created_date: 2026-03-12
last_updated: 2026-03-12
tags: [hillside, initiatives, pipeline]
---

# Initiative Pipeline

Use this table to track potential business initiatives from initial concept through decision.

| Initiative ID | Initiative Name | Portfolio Fit | Stage | Strategic Rationale | Key Risks | ML1 Decision | Owner | Last Updated |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
- `screening`: initial fit/risk review in progress
- `validation`: evidence-gathering and model testing
- `decision`: ready for ML1 go/hold/no-go decision
- `approved`: approved for formal initiative setup
