...
- **Agent Architecture Governance**: Finalize activation status, review cadence, and scope boundaries for all five marketing agents under Strategic Editor oversight.
- **F01 Wind-Down Decision Framework**: Define the trigger conditions and decision criteria under which F01 spend is reduced and F02 becomes the primary channel.
- **Marketing governance cadence**: Establish the ML1 review rhythm for strategy, KPI, and agent outputs.

## Out of Scope

- Funnel-specific execution (owned by LLP-011, LLP-012, LLP-013)
- Lead capture operations and infrastructure (LLP-026)
- Intake pipeline management (LLP-014, LLP-027, LLP-028, LLP-029)
- Legal advice, legal delivery work, or post-conversion matter execution
- Autonomous acceptance or rejection of clients without ML1 approval
- ICP changes without ML1 approval
...
- Risk register and mitigations are documented
- All planning artifacts are complete and internally consistent
