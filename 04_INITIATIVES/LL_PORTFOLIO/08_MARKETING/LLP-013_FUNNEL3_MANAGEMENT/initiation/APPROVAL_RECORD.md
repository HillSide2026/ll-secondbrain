...
- Initiation packet approved for Funnel 03.
...
|------|--------|------|-------|
| `initiation/PROJECT_CHARTER.md` | approved | 2026-03-15 | Initiation purpose, authority, and scope boundary documented |
| `initiation/PROBLEM_STATEMENT.md` | approved | 2026-03-15 | Current-state problem and urgency documented |
| `initiation/SUCCESS_CRITERIA.md` | approved | 2026-03-15 | Initiation success conditions documented |
| `initiation/STAKEHOLDERS.md` | approved | 2026-03-15 | Authority, domain, and governance stakeholders documented |
| `initiation/RISK_SCAN.md` | approved | 2026-03-15 | Canonical initiating-stage risk artifact completed |
| `initiation/APPROVAL_RECORD.md` | approved | 2026-03-15 | ML1 stage-gate decision recorded |
...
| `planning/COMMUNICATION_PLAN.md` | drafted | 2026-03-18 | Review cadence, approval routing, escalation path, and agent communication protocol defined |
| `planning/METRICS.md` | proposed | 2026-03-18 | 7 KPIs with definitions, proposed thresholds, baseline capture period, and validation review gates. Pending ML1 threshold approval. |
