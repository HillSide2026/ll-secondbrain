...
| LLP-011_FUNNEL1_MANAGEMENT (F01) | Executing project | No operational conflict | Executing | F01 targets ICP-01 (Ontario entrepreneur); F03 targets ICP-03 (payments / regulatory audience). No channel overlap. Google Ads budget is F01-only. |
