...
## Assumptions
- Funnel 01 remains active throughout planning and into immediate implementation after ML1 gate approval.
- F1 must achieve all-in ROAS >2.0x to justify continued spend. This is an ML1 hypothesis (2026-03-30) — not yet a formal approved threshold. 2025 actuals (Jan–Oct) were ~1.47x, below this level.
...
- If execution requires actions outside approved boundaries, escalation is mandatory before implementation proceeds.
