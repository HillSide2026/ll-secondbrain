...
Prepare immediate implementation of Opening from Gate 2 (engagement signed) to Gate 3 (opening complete and approved).
...
## Execution Sequence
1. Finalize Gate 2 intake checklist and owner mapping.
...
| Role | Responsibility |
| --- | --- |
| ML1 | Gate authority and threshold approval |
| Assigned Lawyer (AL) | Opening legal-readiness signoff inputs and exceptions |
| Accounts Manager (AM) | Financial readiness ownership |
| Executive Administrator (EA) | Opening checklist execution ownership and record/metadata readiness |
