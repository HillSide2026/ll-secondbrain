---
id: llp-039_project_charter
title: LLP-039 Project Charter
owner: ML1
status: draft
...
Project ID: LLP-039
Project Path: `07_GROWTH_PROJECTS/LLP-039_FINTECH_RETAINER_OPERATING_MODEL`
Stage: Initiating
...
| ID | Criterion |
|---|---|
| SC-01 | Retainer scope is clear enough to distinguish included advisory work from mandatory separate-scope work |
...
- All pricing, client-facing scope, and deviations require ML1 approval.
- The retainer must remain consistent with POL-069.
- Excluded work cannot be silently absorbed into the monthly retainer.
- The model must respect the managing lawyer's 20-hour/week billable capacity.
- Delivery standardization must be compatible with LLP-038.

## Stakeholders

| Role | Name / Agent | Involvement |
|---|---|---|
| Owner / Decision Authority | ML1 | All approvals and strategic decisions |
| Portfolio PM | LLM-004 | Stage-gate and portfolio coherence review |
| Financial Services Practice | LLP-036 | Substantive capability base |
| Delivery Spine | LLP-038 | Delivery standardization and capacity controls |
