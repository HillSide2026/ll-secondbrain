...
List the Stage 2 artifacts by path as required reference inputs:
...
- 04_INITIATIVES/SYSTEM_PORTFOLIO/01_ACTIVE_ROADMAPS/STAGE2/STAGE2_CLOSURE_RECOMMENDATION.md
