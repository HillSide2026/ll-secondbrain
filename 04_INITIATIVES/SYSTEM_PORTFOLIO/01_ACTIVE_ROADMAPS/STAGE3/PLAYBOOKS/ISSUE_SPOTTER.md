...
## Playbook Header
Playbook ID: 02_playbooks__stage3__issue_spotter_md
Version: 1.0
Status: draft
...
## Function
Surface potential issues implied by provided context.

## Output
- Risks to flag (list only)

## Ceiling
- No advice
- No conclusions
- No likelihood or severity
- No recommendations

## Failure Condition
If output feels like judgment or guidance, stop immediately.
